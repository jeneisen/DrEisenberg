	...
	mywebsite = (function() {
		...
		mywebsite.prototype.animateAbout = function() {
			...
			return jQuery("#about").waypoint(function() {
				_this.animateSkills();
				return new Animo({
					el: jQuery("#about .choose_us_block"),
					duration: 600,
					template: {
						translateX: [-50, 0, "%"],
						opacity: [0, 1]
		...
		mywebsite.prototype.animateTeam = function() {
			var _this = this;
			return jQuery(".team_block").waypoint(function() {

				return new Animo({
					el: jQuery(".team_block .team_item"),
					duration: 500,
					delay: 200,
					gap: -65,
					easing: "easeOutBack",
		...
		mywebsite.prototype.animateServices = function() {
			var _this = this;
			return jQuery(".services_block").waypoint(function() {

				return new Animo({
					el: jQuery(".services_block li"),
					duration: 500,
					delay: 300,
					gap: -65,
					easing: "easeOutBack",
		...
		mywebsite.prototype.animateClients = function() {
			var _this = this;
			return jQuery("#clients").waypoint(function() {

				return new Animo({
					el: jQuery("#clients .client_block li"),
					duration: 600,
					delay: 500,
					gap: -85,
					easing: "easeOutBack",
		...
		mywebsite.prototype.animateContact2 = function() {
			var _this = this;
			return jQuery("#contact").waypoint(function() {

				return new Animo({
					el: jQuery("#contact .span3"),
					duration: 500,
					delay: 600,
					gap: -85,
					easing: "easeOutBack",
