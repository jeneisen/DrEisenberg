		...
		jQuery('.btn_load_more').click(function(){
			...
			if (now_load > 0) {
				if (addon_options.type == 0) {
					...
					for (i = i_start-1; i < i_start+now_load-1; i++) {
						loaded_object = loaded_object + '<div class="element added '+ addon_options.items[i].category +'"><div class="blog_item"><div class="blog_img"><img src="'+ addon_options.items[i].src +'" alt="" /><a class="zoom" href="'+ addon_options.items[i].src +'" rel="prettyPhoto[portfolio1]"></a></div><div class="blog_description"><a class="title" href="'+ addon_options.items[i].url +'" alt="">'+ addon_options.items[i].title +'</a><div class="blog_info"><span>Posted by <a href="'+ addon_options.items[i].author_url +'" alt="">'+ addon_options.items[i].post_by +'</a> |</span><span><a href="javascript:void(0);" alt="">'+ addon_options.items[i].post_category +'</a> |</span><span><a href="javascript:void(0);" alt="">'+ addon_options.items[i].post_comments +' Comments</a></span></div><div>'+ addon_options.items[i].content +'</div><a class="post_date" href="javascript:void(0);" alt="">'+ addon_options.items[i].blog_date +'</a></div></div></div>';
					}
				}
